...
var paturlext = '&seed={{SEED}}&patlen={{PATLEN}}&tuples={{TUPLES}}&nested={{NESTED}}&nometro={{NOMETRO}}&tempo={{TEMPO}}&norests={{NORESTS}}&layers={{LAYERS}}&map={{MAP}}&flams={{FLAMS}}&tremolos={{TREMOLOS}}&interest=true';
