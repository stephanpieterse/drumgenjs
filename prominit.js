...
prommetrics.createGauge('drumgen_generated_lilypond', "Total lilypond files generated", ["appid"]);
prommetrics.createGauge('drumgen_generated_images', "Total images generated", ["appid"]);
prommetrics.createGauge('drumgen_generated_audio', "Total audio generated", ["appid"]);
prommetrics.createGauge('drumgen_errors_qtimeout', "Queue timeout errors", ["appid"]);
prommetrics.createGauge('app_pattern_patlen', "Pattern lengths", ["patlen", "appid"]);
prommetrics.createGauge('app_pattern_layers', "Pattern layers", ["layers", "appid"]);
prommetrics.createGauge('app_pattern_tuples', "Pattern tuples", ["tuples", "appid"]);
