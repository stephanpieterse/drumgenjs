...
describe("Main Exported Tests", function() {
    ...
    it("Regression check - lpad should work", function() {
        ...
        // positives
        assert.equal(main.lpad(5, 2), "05", "Padding doesn't work!");
        assert.equal(main.lpad("19", 5), "00019", "Padding doesn't work!");
        assert.equal(main.lpad(5000, 5), "05000", "Padding doesn't work!");

        // negatives
        assert.notEqual(main.lpad("19", 4), "00019", "Padding doesn't work!");
        assert.notEqual(main.lpad(500, 10), "009", "Padding doesn't work!");
